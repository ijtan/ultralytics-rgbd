...
N_CHANNELS = 3  # number of channels (3: RGB, 4: RGBA)
...
class Exporter:
    ...
    def __call__(self, model=None):
        ...
        # Input
        im = torch.zeros(self.args.batch, N_CHANNELS, *self.imgsz).to(self.device)
        file = Path(
    ...
    def export_ncnn(self, prefix=colorstr("ncnn:")):
        ...
        cmd = [
            ...
            *pnnx_args,
            ...
            f'inputshape="{[self.args.batch, N_CHANNELS, *self.imgsz]}"',
        ]
    ...
    def _pipeline_coreml(
        ...
        pipeline = ct.models.pipeline.Pipeline(
            input_features=[
                ("image", ct.models.datatypes.Array(N_CHANNELS, ny, nx)),
