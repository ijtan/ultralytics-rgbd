...
You can now use Roboflow to organize, label, prepare, version, and host your datasets for training YOLOv5 (rocket_emoji) models. Roboflow is free to use with YOLOv5 if you make your workspace public.
