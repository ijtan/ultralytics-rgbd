...
Ultralytics HUB datasets are just like YOLOv5 and YOLOv8 (rocket_emoji) datasets. They use the same structure and the same label formats to keep everything simple.
